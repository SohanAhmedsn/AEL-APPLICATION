...
namespace AEL.API.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("{id:int}")]
        public async Task<IActionResult> GetByRegionId([FromRoute] int id)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateRegion([FromBody] BookDTO creatDto)
        {
            if (ModelState.IsValid)
            {
                ...
                return CreatedAtAction(nameof(GetByRegionId), new { id = bookDTO.Id }, bookDTO);
            }
            else
            {
        ...
        [HttpPut]
        [Route("{id:int}")]
        public async Task<IActionResult> UpdateRegion([FromRoute] int id, [FromBody] BookDTO updatebookDTO)
        {
        ...
        [HttpDelete]
        [Route("{id:int}")]
        public async Task<IActionResult> UpdateRegion([FromRoute] int id)
        {
